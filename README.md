...
| `arrow_separator1`   | `"string"`      | `""`          | 🌍 The first character is adopted. |
| `arrow_separator2`   | `"string"`      | `""`          | 📅 The first character is adopted. |
| `arrow_separator3`   | `"string"`      | `""`          | ⌚ The first character is adopted. |
